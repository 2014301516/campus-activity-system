...
CREATE TABLE activities (
    ...
    status               VARCHAR(20)  NOT NULL DEFAULT 'draft' COMMENT '状态: draft/pending/approved/rejected/ongoing/ended/cancel_pending/cancelled',
    cancel_request_reason VARCHAR(255) DEFAULT NULL COMMENT '组织者申请取消活动的理由',
    reject_reason        VARCHAR(255) DEFAULT NULL COMMENT '管理员驳回活动或取消申请的理由',
    created_at           DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_at           DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (id),
